                      ...
                      fluidPage(
                        sidebarLayout(
                          ...
                          mainPanel(
                            ...
                            tags$p(tags$i("Référence à citer : Matthias Gamer, Jim Lemon and Ian Fellows Puspendra Singh (2019). irr: Various Coefficients of Interrater Reliability and Agreement. R package version 0.84.1. https://CRAN.R-project.org/package=irr")),
                            ...
                            tags$p(tags$i("Référence à citer :Terry M. Therneau, Patricia M. Grambsch (2000). _Modeling Survival Data: Extending the Cox Model_. Springer, New York. ISBN 0-387-98784-3"))
                            )   # fin Main panel
                        )   # fin sidebarlayout
                      )   # fin fluidpage
             )
